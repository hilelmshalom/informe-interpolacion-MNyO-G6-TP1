...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\textwidth]{graf1.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\textwidth]{graf2.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\textwidth]{graf3.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\textwidth]{graf4.png}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.5\textwidth]{graf8.png}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.5\textwidth]{graf9.png}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.5\textwidth]{graf10.png}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.5\textwidth]{graf11.png}
...
%{En esta sección se hace un resumen de lo realizado en todo el trabajo. Se destacan los descubrimientos mas importantes. Se detallan limitaciones de los métodos. Se pueden incluir futuros pasos. }
...
%Jiménez Bedolla, J. C. (2022). Métodos numéricos usando Python con aplicaciones a la Ingeniería Química (1st ed., pp. 26-46). UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO.

\bibitem{Jimenez}
Jiménez Bedolla, J. C. (2022). Métodos numéricos usando Python con aplicaciones a la Ingeniería Química (1st ed., pp. 26-46). UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO.
%Burden, R. L., & Faires, D. J. (2011). Numerical Analysis (9th ed., pp. 26-46). BROOKS/COLE CENGAGE Learning.
\bibitem{Burden}
Burden, R. L., & Faires, D. J. (2011). Numerical Analysis (9th ed., pp. 26-46). BROOKS/COLE CENGAGE Learning.
%Salomon, H. M., & Fadel, V. N. (2024, March 17). Informe-interpolacion-MNyO-G6-TP1. GitHub. Retrieved March 27, 2024, from https://github.com/hilelmshalom/informe-interpolacion-MNyO-G6-TP1
\bibitem{Salomon}
Salomon, H. M., & Fadel, V. N. (2024, March 17). Informe-interpolacion-MNyO-G6-TP1. GitHub. Retrieved March 27, 2024, from https://github.com/hilelmshalom/informe-interpolacion-MNyO-G6-TP1
